...
function timeSpanToString(startDate, endDate) {
  const HH = new Date(endDate).getHours() - new Date(startDate).getHours();
  const mm = new Date(endDate).getMinutes() - new Date(startDate).getMinutes();
  const ss = new Date(endDate).getSeconds() - new Date(startDate).getSeconds();
  const sss = new Date(endDate).getMilliseconds() - new Date(startDate).getMilliseconds();

  const pad = (date) => String(date).padStart(2, '0');
